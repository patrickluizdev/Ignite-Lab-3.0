...
export function App() {
  return (
    <div className='flex flex-col w-screen h-screen bg-gray-900 items-center justify-center text-gray-100'>
      <div className='w-1/5 max-w-sm min-w-80'>
        ...
        <form className='flex flex-col items-stretch w-full mt-10 gap-4'>
        ...
        <footer className='flex flex-col items-center gap-4  mt-8 w-full'>
